...
function contains_671088685(pattern_671088686, self_671088687) {
  var result_671088688 = false;

  var F = {procname: "jsre.contains", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 58;
    result_671088688 = self_671088687.test(pattern_671088686);
  framePtr = F.prev;

  return result_671088688;
...
if (!(contains_671088685("abc", jsregex_654311426))) {
F.line = 53;
...
if (!(!(contains_671088685("abcd", jsregex_654311426)))) {
F.line = 53;
...
if (!(contains_671088685("xabc", jsregex_654311426))) {
F.line = 53;
...
function startsWith_671088689(pattern_671088690, self_671088691) {
  var result_671088692 = false;

  var F = {procname: "jsre.startsWith", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 61;
    result_671088692 = contains_671088685(pattern_671088690, new RegExp(toJSStr(([94] || []).concat(cstrToNimstr(self_671088691.source) || [])), self_671088691.flags));
  framePtr = F.prev;
...
if (!(startsWith_671088689("abcd", jsregex_687865858))) {
F.line = 62;
...
function endsWith_671088702(pattern_671088703, self_671088704) {
  var result_671088705 = false;

  var F = {procname: "jsre.endsWith", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 68;
    result_671088705 = contains_671088685(pattern_671088703, new RegExp(toJSStr((cstrToNimstr(self_671088704.source) || []).concat([36] || [])), self_671088704.flags));
  framePtr = F.prev;

  return result_671088705;
...
if (!(endsWith_671088702("abcd", jsregex_704643074))) {
F.line = 69;
...
function HEX3DHEX3D_721420300(x_721420302, y_721420303) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      var i_721420326 = 0;
      F.line = 75;
      var colontmp__721420408 = 0;
      F.line = 333;
      colontmp__721420408 = subInt((x_721420302).length, 1);
      F.line = 90;
      var res_721420410 = 0;
      Label2: {
        F.line = 91;
          Label3: while (true) {
          if (!(res_721420410 <= colontmp__721420408)) break Label3;
            F.line = 333;
            i_721420326 = res_721420410;
            ...
            F.line = 93;
            res_721420410 = addInt(res_721420410, 1);
          }
      };
    };
    F.line = 337;
...
function HEX24_671088682(self_671088683) {
  var result_671088684 = [];

  var F = {procname: "jsre.$", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 49;
    result_671088684 = nimCopy(null, cstrToNimstr(self_671088683.toString()), NTI33554449);
  framePtr = F.prev;
...
if (!(contains_671088685("nim javascript", jsregex_721420290))) {
F.line = 75;
...
if (!(contains_671088685("0123456789abcd", jsregex_721420290))) {
F.line = 75;
...
if (!(eqStrings(HEX24_671088682(jsregex_721420290), [47,91,48,45,57,93,47,105]))) {
F.line = 75;
...
if (!(startsWith_671088689("abcd", jsregex_721420290))) {
F.line = 75;
...
if (!(endsWith_671088702("dabc", jsregex_721420290))) {
F.line = 75;
...
F.line = 75;
var digitsRegex_721420375 = new RegExp("\\d");
if (!(HEX3DHEX3D_721420300(("foo".match(digitsRegex_721420375) || []), []))) {
F.line = 75;
failedAssertImpl_268435515(makeNimstrLit("/home/runner/work/Nim/Nim/doc/html/nimcache/runnableExamples/jsre_examples_4.nim(24, 3) `\"foo\".match(digitsRegex) == @[]` "));
}
